        ...
        children: [
          Center(
            child: Directionality(
              ...
              child: Text(
                "اهلا بك في تطبيق إسلامى متكامل",
          ...
          LastReadCard(
            surahName:sharedPreferences.getString("surahPageName")!=null?
          ...
          const SizedBox(height: 20),
          LastReadCard(
            ayahNumber: sharedPreferences.getInt("ayahNumber") ?? 0,
            surahName:
