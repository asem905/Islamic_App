...
// Function to calculate absolute ayah number
    ...
    return Scaffold(
      ...
      body: BlocBuilder<QuaranCubit, QuaranState>(
        builder: (context, state) {
          ...
          print("Surah Name: ${widget.surahName}");
          ...
          if (state is QuaranLoading) {
            ...
            print("Surah Name: $newName");
            print("Surah English Name: $newEnglishName");
            return Column(
              children: [
                _buildSurahHeader(),
                _buildControlBar(),
            ...
            return Column(
              ...
              children: [
                Center(child: Text(state.errorMessage, style:const TextStyle(color: Colors.red, fontSize: 18))),
                const SizedBox(height: 16),
                ElevatedButton(
                  onPressed: () {
                    context.read<QuaranCubit>().getSurah(widget.surahNumber);
                  },
                  child: const Icon(Icons.refresh, size: 30, color: Colors.red),
                ),
              ]
            );
          }else{
      ...
      leading: IconButton(
        ...
        onPressed: () {
          if(widget.surahNumber>1){
            ...
            MaterialPageRoute(builder: (context) => SurahReadingPage(
  ...
  Widget _buildSurahHeader() {
    print("Surah Header================================: $newName");
    print("Surah English Header=========================: $newEnglishName");
    return Container(
   ...
   _buildAyahsList() {
    return Container(
      color: _isNightMode ? AppColors.darkBackground : AppColors.lightBackground,
   ...
   _buildAyahItem(dynamic ayah, int index) {
    ...
    int absoluteAyahNumber = _audioController.getAbsoluteAyahNumber(widget.surahNumber, index+1);
print('The absolute ayah number of Ayat Al-Kursi is: $absoluteAyahNumber');
    final audioUrl = _audioController.getAyahAudioUrl(
      reciter: 'ar.alafasy', // Default reciter - you can make this configurable
      quality: '128',  ayahNumber: absoluteAyahNumber, // Default quality - you can make this configurable
    );
        ...
        children: [
            ...
            children: [
              ...
              StreamBuilder<QuranPlayerState>(
                ...
                builder: (context, snapshot) {
                  ...
                  final isThisAyahPlaying = playerState?.ayahIndex == index && isPlaying;
                  ...
                  return IconButton(
                    icon: Icon(
                      ...
                      color: isThisAyahPlaying
                          ...
                          : (_isNightMode ? Colors.white70 : AppColors.shadowLight),
                    ),
                    onPressed: () {
          ...
          Directionality(
            ...
            child: Text(
              ...
              index==0? ayahs[index].text.replaceFirst('بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ ',' '):ayahs[index].text,
              style: GoogleFonts.scheherazadeNew(
                fontSize: _fontSize,
                height: 1.6,
