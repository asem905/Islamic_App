    ...
    return GridView.count(
      ...
      children: [
        ...
        FeatureCard(
          ...
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => const QuranViewSelectionPage()));
          },
        ),
        ...
        FeatureCard(
          ...
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => const AthkarHomePage()));
          },
        ),
        ...
        FeatureCard(
          ...
          color: AppColors.qiblaColor,
          onTap: () {
            Navigator.of(context).push(MaterialPageRoute(builder: (context) => const PrayerTimesPage()));
          },
        ),
      ],
    );
